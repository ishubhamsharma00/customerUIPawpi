      ...
      {links.map((link) => (
        <div className="" key={link.id}>
          ...
          <div className="text-left lg:cursor-pointer group h-full w-full">
            <h1
              className="flex items-center justify-between  uppercase group-hover:text-purple-500 lg:cursor-pointer font-paw md:text-2xl lg:text-lg px-3 lg:capitalize font-semibold lg:font-normal"
              onClick={() => {
            ...
            >
              <div className="flex items-center gap-3">
                ...
                />
                <Link to={link.id} className="hidden lg:contents">
                  {link.name}
                </Link>
                    ...
                    {link.sublinks.map((mysublinks) => (
                      <div key={mysublinks.sublinksid}>
                        ...
                        {mysublinks.sublink.map((slink) => (
                          <li
                            className="text-sm font-paw pl-2 mt-1"
                            key={slink.sublinkid}
                          >
                            <Link
                              to={slink.link}
