        ...
        <>
            <div className='flex items-center justify-between h-24 w-full bg-white'>
                <div className='w-[48%] h-full flex items-center justify-between'>
                    <img src={TestingImg} alt='CartProductImage' className='w-24 h-24 rounded-lg border-2 border-gray-300 p-2 shadow-xl'/>
                    <div className='flex flex-col items-start justify-between w-[63%] h-full'>
                        <p className='line-clamp-2 text-sm'>Royal Canin Mini Starter Dry Food</p>
                ...
                <div className='w-[48%] flex justify-between items-center'>
                    <div className='w-[31%] flex items-center justify-center gap-2'>
                        <p className='text-xl cursor-pointer outline-none' onClick={decreaseQuantity}>-</p>
                        <p className='p-1 px-3 font-semibold border border-gray-400 rounded-md'>{quantity}</p>
                        <p className='text-xl cursor-pointer outline-none' onClick={increaseQuantity}>+</p>
                    </div>
                                            ...
                                            <div className="relative h-full py-2 flex-1 w-[90%] m-auto sm:px-6 md:px-0">
                                                <div className='w-full text-slate-500 pb-6 flex items-center justify-between'>
                                                    ...
                                                    <div className='w-[48%] flex items-center justify-between'>
                                                        <p className='w-[31%] flex items-center justify-center'>QUANTITY</p>
                                                        <p className='w-[31%] flex items-center justify-center'>PRICE</p>
                                                        <p className='w-[31%] flex items-center justify-center'>TOTAL</p>
                                                    </div>
                                                </div>
                                                ...
                                                <Link to={"/auth/checkout"} className='fixed w-[90%] bottom-1 flex font-paw justify-between items-center bg-purple-500 text-white rounded-lg px-4 md:py-4 py-2 cursor-pointer mt-4 hover:bg-purple-600' >
